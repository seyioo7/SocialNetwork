...
public class PostActivity extends AppCompatActivity {
    ...
    private void ValidatePostInfo() {
        ...
        if (ImageUri == null){
            ...
            loadingBar.setMessage("please wait, while we are Updating your Your New Post");
            loadingBar.show();
        ...
        filePath.putFile(ImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    // coming back here for correction
                ...
                .addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(PostActivity.this, "Error occured whill updating your post.", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                        }
                    }
                });
